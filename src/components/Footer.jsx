  ...
  return (
    <footer className="py-4 px-6 bg-[#050505] border-t border-white/5">
      <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-y-6">
        ...
        {/* Social Icons - Top Left on Mobile, Left on Desktop */}
        <div className="w-1/2 md:w-1/3 flex justify-start order-1 md:order-1">
        ...
        {/* Location - Top Right on Mobile, Right on Desktop */}
        <div className="w-1/2 md:w-1/3 flex justify-end order-2 md:order-3">
        ...
        {/* Copyright - Bottom Center on Mobile, Center on Desktop */}
        <div className="w-full md:w-1/3 flex justify-center order-3 md:order-2">
          <p className="text-slate-500 text-[10px] sm:text-[11px] font-mono uppercase tracking-[0.2em] text-center">
            © 2026 <span className="text-slate-300 font-bold">Menaka Mohanraj | All Rights Reserved</span>
          </p>
        </div>
